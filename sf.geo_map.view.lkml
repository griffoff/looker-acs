...
#   }
  ...
  dimension: county_name {
    group_label: "County"
    sql: ARRAY_TO_STRING(ARRAY_CONSTRUCT(${TABLE}.county_name, ${state_name}), ', ');;
    link: {
      url: "https://maps.google.com?q={{value}}"
      label: "Google Maps"
    }
...
#   }
  ...
  dimension: tract_name {
    sql: ARRAY_TO_STRING(ARRAY_CONSTRUCT(${TABLE}.tract_name, ${county_name}), ', ');;
    group_label: "Tract"
    link: {
...
#   }
  ...
  dimension: block_group_name {
    sql: ARRAY_TO_STRING(ARRAY_CONSTRUCT(${TABLE}.block_group_name, ${tract_name}), ', ');;
    group_label: "Block Group"
    suggest_persist_for: "120 hours"
  }
